...
plt.plot(episode_durations,color="blue" if __name__=="__main__" else "green") # If task 2 (imported) the color should be green
plt.plot(mean_episode_durations,color="orange" if __name__=="__main__" else "red") # If task 2 (imported) the color should be red
plt.xlabel("Episode")
plt.ylabel("Duration")
plt.title("Result")
plt.show(block=1)
